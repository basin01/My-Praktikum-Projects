...
| [Сформулировать ценностное предложение SQL](analysis_of_data_using_SQL) |Бизнес, Интернет-сервисы| Используя данные приобретенной компании по чтению книг онлайн, нужно проанализировать базу на популярность книг и авторов для формулирования предложения клиенту | *Pandas, BS4, SQLAlchemy, Выгрузка данных* |
